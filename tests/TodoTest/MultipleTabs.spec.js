...
test.describe('Multiplet Tab', () => {

  test('Todo Multiple Tabs', async ({ page, context }) => {
    ...
    // input todo on second tab
    await page2.getByRole('textbox', { name: 'What needs to be done?' }).click;
